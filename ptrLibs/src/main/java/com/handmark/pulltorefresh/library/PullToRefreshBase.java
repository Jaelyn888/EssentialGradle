...
//		Mode mode;
//		if(newMode==Mode.PULL_FROM_END_STRETCH_START){
//			mHeaderLayout.setVisibility(INVISIBLE);
//			mode=Mode.BOTH;
//			mLayoutVisibilityChangesEnabled=false;
//		} else if (newMode == Mode.PULL_FROM_START_STRETCH_END) {
//			mFooterLayout.setVisibility(INVISIBLE);
//			mode=Mode.BOTH;
//			mLayoutVisibilityChangesEnabled=false;
//		} else if (newMode == Mode.DISABLED_STRETCH_BOTH) {
//			mHeaderLayout.setVisibility(INVISIBLE);
//			mFooterLayout.setVisibility(INVISIBLE);
//			mode=Mode.BOTH;
//			mLayoutVisibilityChangesEnabled=false;
...
//		}
	...
	protected  boolean getmLayoutVisibilityChangesEnabled(){
		  return mLayoutVisibilityChangesEnabled;
	}
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
			...
			if (mCurrentMode == Mode.PULL_FROM_START) {
				...
				String lable=context.getString(R.string.pull_to_refresh_last_time) +mSimpleDateFormat.format(new Date());
				getHeaderLayout().setLastUpdatedLabel(lable);
	...
	public static enum Mode {
		 ...
		 * 顶部刷新，底部回弹
		 */
		PULL_FROM_START_STRETCH_END(0x5),

		/**
		 * 顶部刷新，底部回弹
		 */
		PULL_FROM_END_STRETCH_START(0x6),
		/**
		 * 顶部刷新，底部回弹
		 */
		DISABLED_STRETCH_BOTH(0x7);
	...
	public final void onRefreshComplete() {
		if (isRefreshing()) {
			boolean mLayoutVisibilityChangesEnabledTmp=mLayoutVisibilityChangesEnabled;
			setState(State.RESET);
			mLayoutVisibilityChangesEnabled=mLayoutVisibilityChangesEnabledTmp;
		}
	}
	/**
