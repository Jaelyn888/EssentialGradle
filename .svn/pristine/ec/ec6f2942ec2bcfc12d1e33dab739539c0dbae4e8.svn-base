...
public class BaseActivity extends AFinalActivity {
	 ...
	 * 商品图片的点击 进入大图
	 *
	 * @param picModelArrayList
	 * @param picPosition
	 */
	public void goodsImage_click(ArrayList<ProductPicModel> picModelArrayList, int picPosition) {
		Intent intent = new Intent(mContext, ShowBigImageActivity.class);
		intent.putExtra(Constant.IMAGE_JSON_STR, picModelArrayList);
	...
	public MyLoadingDataDialogManager initLoadingToast() {
