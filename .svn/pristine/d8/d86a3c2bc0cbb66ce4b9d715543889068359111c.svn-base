 ...
 */
public class MyOrderDetailProductAdapter extends MyBaseAdapter {
    ...
    public MyOrderDetailProductAdapter(Context context) {
        super(context);
    }

    public MyOrderDetailProductAdapter(Context context, List<? extends Map<String, ?>> datas) {
        super(context, datas);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.item_my_order_detail_pro, viewGroup, false);
...
//
//		if(jsonMap.getStringNoNull("productActivityPrice").equals(jsonMap.getStringNoNull("productPrice"))){
//			shopCartAdapterViewHolder.goods_price_tv
//					.setText(StringUtils.getFormatMoneyWithSign(jsonMap.getStringNoNull("productPrice")));
//		}else{
//			shopCartAdapterViewHolder.goods_price_tv
//					.setText(StringUtils.getFormatMoneyWithSign(jsonMap.getStringNoNull("productActivityPrice")));
//		}
        ...
        if (returnRefundStatus == 21 || returnRefundStatus == 23 || returnRefundStatus == 24 || returnRefundStatus == 41
            ...
            shopCartAdapterViewHolder.goods_discribe_tv.setEnabled(false);
            shopCartAdapterViewHolder.goods_discribe_tv.setBackgroundResource(R.color.transparentsss);
        ...
        } else if (returnRefundStatus == 11 || returnRefundStatus == 13 || returnRefundStatus == 14
                || returnRefundStatus == 18 || returnRefundStatus == 31 || returnRefundStatus == 33
                || returnRefundStatus == 34 || returnRefundStatus == 38) {
            shopCartAdapterViewHolder.goods_discribe_tv.setEnabled(false);
            shopCartAdapterViewHolder.goods_discribe_tv.setBackgroundResource(R.color.transparentsss);
        ...
        switch (orderStatus) {
            case 1:
                ...
                break;
            case 2:
                if (returnRefundStatus == 0 || returnRefundStatus == 22 || returnRefundStatus == 25) {
                    shopCartAdapterViewHolder.goods_discribe_tv.setEnabled(true);
                    shopCartAdapterViewHolder.goods_discribe_tv.setText("退款");
                    shopCartAdapterViewHolder.goods_discribe_tv.setBackgroundResource(R.drawable.cus_black_white_bt);
                    shopCartAdapterViewHolder.goods_discribe_tv.setPadding(26, 10, 26, 10);
                }
                break;
            case 3:
                if (returnRefundStatus == 0 || returnRefundStatus == 22 || returnRefundStatus == 25) {
                ...
                break;
            case 4:
                if (returnRefundStatus == 0 || returnRefundStatus == 12 || returnRefundStatus == 15
                        || returnRefundStatus == 19 || returnRefundStatus == 22 || returnRefundStatus == 25) {
                    shopCartAdapterViewHolder.goods_discribe_tv.setEnabled(true);
                    shopCartAdapterViewHolder.goods_discribe_tv.setText("退款/退货");
                    shopCartAdapterViewHolder.goods_discribe_tv.setBackgroundResource(R.drawable.cus_black_white_bt);
                    shopCartAdapterViewHolder.goods_discribe_tv.setPadding(26, 10, 26, 10);
                }
                break;
