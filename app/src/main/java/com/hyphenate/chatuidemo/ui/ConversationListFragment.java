        ...
        if (username.equals(EMClient.getInstance().getCurrentUser()))
            ...
            if (conversation.isGroup()) {
                if (conversation.getType() == EMConversationType.ChatRoom) {
                    // it's group chat
                    ((BaseActivity)getActivity()).contactCustomService(username, Constant.CHATTYPE_CHATROOM,false);
                } else {
                    ((BaseActivity)getActivity()).contactCustomService(username, Constant.CHATTYPE_GROUP,false);
                }

            } else {
                ((BaseActivity)getActivity()).contactCustomService(username, Constant.CHATTYPE_SINGLE,false);
            }
        }
