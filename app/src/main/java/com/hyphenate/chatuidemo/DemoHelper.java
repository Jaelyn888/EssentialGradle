...
//
    ...
    protected void onConnectionConflict(){
        ToastUtil.initToast(appContext).showToast(R.string.connect_conflict);
       // Intent intent = new Intent(appContext, MainActivity2.class);
...
//        intent.putExtra(Constant.ACCOUNT_CONFLICT, true);
    ...
    protected void onCurrentAccountRemoved(){
        ToastUtil.initToast(appContext).showToast(R.string.em_user_remove);
        //Intent intent = new Intent(appContext, MainActivity2.class);
...
//        intent.putExtra(Constant.ACCOUNT_REMOVED, true);
	...
	private EaseUser getUserInfo(String username){
        ...
        if(username.equals(com.yishanxiu.yishang.utils.Constant.IM)){
            user.setNick("客服");
        }
        return user;
	}
